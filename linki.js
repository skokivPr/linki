...
const categories = [
    {
        ...
        links: [
            ...
            {
                href: "https://codemyui.com/tag/neumorphic-design/",
                text: "CodeMyUI ",
                description: "Przykłady projektów neumorfizmu",
    ...
    },
    {
        ...
        links: [
            ...
            },
            {
                ...
                text: "Tutorials Point Whiteboard",
...
function generateLinks() {
    ...
    categories.forEach((category) => {
        ...
        category.links.forEach((link) => {
            ...
            linkElement.className = "link-button"; // Użycie customowej klasy

            // Ustawienie dynamicznego koloru tła przycisku
            linkElement.style.backgroundColor = link.buttonBgColor;

            // Dodanie event listenerów dla efektu hover
            linkElement.onmouseover = () => {
                linkElement.style.backgroundColor = link.buttonHoverBgColor;
                linkElement.style.borderColor = link.buttonHoverBorderColor;
            };
            linkElement.onmouseout = () => {
                linkElement.style.backgroundColor = link.buttonBgColor;
                linkElement.style.borderColor = "rgba(255, 255, 255, 0.1)"; // Przywróć domyślny kolor ramki
            };

            // Dodanie ikony, jeśli jest dostępna
            if (link.icon) {
                const iconElement = document.createElement("i");
                // Dodaj klasę koloru ikony z danych
            ...
            linkText.className = "link-text"; // Użycie customowej klasy
            ...
            if (link.description) {
                ...
                linkDescription.className = "link-description"; // Użycie customowej klasy
